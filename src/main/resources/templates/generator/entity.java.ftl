...
<#if table.importPackages?? && table.importPackages?size!=0>
...
<#if superEntityClass??>
public class ${entity}Domain extends ${superEntityClass}<#if activeRecord><${entity}></#if> {
<#elseif activeRecord>
public class ${entity}Domain extends Model<${entity}> {
<#else>
